...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Sénégal sur mesure — Voyage personnalisé avec Diambar" },
      { name: "twitter:description", content: "Découvrez le Sénégal autrement. Séjours 100% sur mesure avec Diambar, guide local passionné. Dakar, Gorée, Lac Rose, Saint-Louis, désert de Lompoul." },
