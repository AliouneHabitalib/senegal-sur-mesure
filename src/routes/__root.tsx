...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Agence de voyage au Sénégal. Séjours 100% sur mesure avec guide privé : Dakar, Gorée, Lac Rose, Sine Saloum, Lompoul, Saint-Louis." },
      { name: "keywords", content: "voyage Sénégal, séjour sur mesure Sénégal, agence tourisme Sénégal, guide privé Dakar, safari Sénégal" },
      { name: "author", content: "Diambar Travel Tour" },
      { property: "og:title", content: "Sénégal sur mesure — Diambar Travel Tour" },
      { property: "og:description", content: "Agence de voyage au Sénégal. Séjours 100% sur mesure avec guide privé : Dakar, Gorée, Lac Rose, Sine Saloum, Lompoul, Saint-Louis." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Sénégal sur mesure — Diambar Travel Tour" },
      { name: "twitter:description", content: "Agence de voyage au Sénégal. Séjours 100% sur mesure avec guide privé : Dakar, Gorée, Lac Rose, Sine Saloum, Lompoul, Saint-Louis." },
